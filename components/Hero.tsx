...
const Hero = () => {
  return (
    <header className="cursor-default max-w-[1650px] mx-auto relative  md:pt-10 pt-20 lg:gap-x-2 w-full flex lg:flex-row md:flex-row lg:justify-center items-center flex-col justify-start bg-gray-100/50" id="home">
